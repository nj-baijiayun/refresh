...
public class HolderAdapterProcessor extends BaseProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        Map<String, GroupProcessorModel> groupMap = HolderTypeModelHelper.getHolderClassArray(roundEnvironment);
        java.util.List<String> holderClsName = HolderTypeModelHelper.getModelTypeHolderClsName(roundEnvironment);
